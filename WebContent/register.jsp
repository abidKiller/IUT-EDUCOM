<html>
    ...
    <body>
        ...
        <div id="form">
            <form method="POST" action="databaseInsert.jsp">
                <label id="form-title">Register</label><br><br>
                <input class="form-field" type="text" name="userId" placeholder="Your ID"><br><br>
                <input class="form-field" type="text" name="userName" placeholder="Your Name"><br><br>
                <input class="form-field" type="password" name="userPassword" placeholder="Password"><br><br>
                <input class="form-field" type="password" name="userPasswordConfirm" placeholder="Re-type Password"><br><br>
                <input class="mdc-button mdc-button--raised button-style" type="submit" value="Register">
            </form>
        </div>
